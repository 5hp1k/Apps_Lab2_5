...
largest_team_size = session.query(func.max(func.length(Jobs.collaborators))).scalar()
...
if len(team_leaders) == 1:
    print(f"Team lead with the largest team {team_leaders[0].surname} {team_leaders[0].name}")
else:
